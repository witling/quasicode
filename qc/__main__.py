...
def argument_parser():
    ...
    parser_run.add_argument('--automain', action='store_true', default=False, help='move statements other than declare and import to a default main method.')
...
def run(args):
    program = Program.load(args.program, auto_main=args.automain)
