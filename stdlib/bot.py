...
class BotLibrary(PyLibrary):
    ...
    def __init__(self):
        ...
        self.ident('fahre', create_fn(self._drive))
        self.ident('lenke', create_fn(self._steer))
        self.ident('stop', create_fn(self._stop))
        self.ident('linetracker', create_fn(self._linetracker))

        self.ident('ist_sensor_frei?', create_fn(self._check_sensor))
        self.ident('klassifiziere?', create_fn(self._classify))
